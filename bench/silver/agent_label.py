"""Silver labels from model reviewers: real public documents labelled person, org, and
address under internal/bench/review/GUIDELINES.md, for detector training. Emails and phones
come from the rules layer at training time and are not labelled here.
...
data/interim/silver/r<ROUND>/train.jsonl.
"""
...
PLAN = {1: {"federal-register": 150, "govuk": 150}}
